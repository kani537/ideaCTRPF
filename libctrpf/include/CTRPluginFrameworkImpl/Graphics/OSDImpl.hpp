...
class OSDImpl {
  struct OSDMessage {
    ...
    OSDMessage(std::string const& str, Color fg, Color bg);
  };
 ...
 public:
  ...
  static u32 MainCallback(u32 isBottom, int arg2, void* leftFb,
                          void* rightFb, int stride, int format,
                          int arg7);
  static u32 MainCallback2(u32 r0, u32* params, u32 isBottom,
                           u32 arg);
  static Result OnTopScreenFrame();
  static Result OnBottomScreenFrame();
  static void CallbackCommon(u32 isBottom, void* leftFb,
                             void* rightFb, int stride, int format,
                             int swap);
